...
def main(dataset_path, temp_dir):
            ...
            for sentence_ind, sent in enumerate(sentences):
                ...
                for token_ind, token in enumerate(sentence):
                    ...
                    if len(cc) > 1:
                        ...
                        sentence.tokens[token_ind] = Token(word + "$" + str(cluster))
    ...
    for label in labels:
        ...
        def read_text_file(file_path):
            with open(Path(file_path), 'r',encoding='ISO-8859-1') as f:
                return f.read()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_path', type=str, default='/home/garrett/ConWea_modification/data/spam/Annotated/')
